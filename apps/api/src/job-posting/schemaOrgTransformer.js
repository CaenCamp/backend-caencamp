...
const formatJobPosting = (dbJobPosting) => {
    return dbJobPosting
        ? {
              ...
              datePosted: dbJobPosting.datePosted ? formatISO(new Date(dbJobPosting.datePosted)) : null,
              jobStartDate: dbJobPosting.jobStartDate ? formatISO(new Date(dbJobPosting.jobStartDate)) : null,
              validThrough: dbJobPosting.validThrough ? formatISO(new Date(dbJobPosting.validThrough)) : null,
          }
        : {};
};
