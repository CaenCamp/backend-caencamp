...
const TagPagination = (props) => <Pagination rowsPerPageOptions={[10, 25, 50]} {...props} />;
    ...
    return (
        ...
        >
            <Datagrid>
                ...
                <NumberField source="nbTalks" label="Nombre de talks associés" sortable={true} />
                <EditButton />
            </Datagrid>
        </List>
    );
...
const TagTitle = ({ record }) => (record ? `Edition du tag "${record.label}"` : null);

export const TagEdit = (props) => (
    <Edit title={<TagTitle />} {...props}>
        <SimpleForm>
            <TextInput fullWidth source="label" validate={required()} />
            <ReferenceArrayField label="Talks associés" reference="talks" source="talks">
                <SingleFieldList>
