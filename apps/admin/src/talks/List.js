...
const TalkFilters = (props) => (
    <Filter {...props}>
        <TextInput source="title:%l%" label="Titre" alwaysOn />
...
const WebsitesField = ({ record = {} }) => <span>{record.websites.length}</span>;
...
const TalkPagination = (props) => <Pagination rowsPerPageOptions={[10, 25]} {...props} />;
    ...
    return (
        ...
        >
            <Datagrid>
                ...
                <ReferenceArrayField label="Le.s speaker.s" reference="speakers" source="speakers" perPage={100}>
                    <SingleFieldList>
                        <ChipField source="name" />
                    </SingleFieldList>
                </ReferenceArrayField>
                <ReferenceArrayField label="Le.s tag.s" reference="tags" source="tags" perPage={100}>
                    <SingleFieldList>
                        <ChipField source="label" />
                    </SingleFieldList>
                </ReferenceArrayField>
