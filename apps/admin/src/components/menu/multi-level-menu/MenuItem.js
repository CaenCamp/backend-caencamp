...
var MenuItem = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        hasSubItems && (React.createElement(Collapse_1.default, { in: isOpen, component: react_1.forwardRef(function (props, ref) { return (React.createElement("li", __assign({ id: name + "-submenu", ref: ref }, props))); }), unmountOnExit: true },
