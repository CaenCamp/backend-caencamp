...
const EditionTitle = ({ record }) => (record ? `Edition ${record.title}` : null);
        ...
        <Edit title={<EditionTitle />} {...props}>
            <TabbedForm>
                <FormTab label="L'edition">
                    ...
                    <ReferenceInput label="Categorie" source="categoryId" reference="edition-categories">
                    ...
                    <TextInput fullWidth multiline label="Résumé" source="shortDescription" validate={required()} />
                    <MarkdownInput
