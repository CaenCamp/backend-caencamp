...
const WebSitePagination = (props) => <Pagination rowsPerPageOptions={[10, 25]} {...props} />;
...
export const WebSiteCreate = (props) => {
    ...
    const speakerId = location.state && location.state.record ? location.state.record.speakerId : undefined;
